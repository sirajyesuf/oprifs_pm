...
@section('multiple-action-button')
    @if ((isset($permissions) && in_array('create bug report', $permissions)) || ($currentWorkspace && $currentWorkspace->permission == 'Owner'))
        <a href="#" class="btn btn-xs btn-white btn-icon-only width-auto" data-ajax-popup="true" data-size="lg"
            ...
            data-url="{{ route('projects.bug.report.create', [$currentWorkspace->slug, $project->id]) }}"><i
                                                                            ...
                                                                            <div class="dropdown-menu dropdown-menu-right"
                                                                                ...
                                                                                @if ($currentWorkspace->permission == 'Owner')
                                                                                    <a href="#" class="dropdown-item"
                                                                                        ...
                                                                                        data-url="{{ route('projects.bug.report.edit', [$currentWorkspace->slug, $bug->project_id, $bug->id]) }}">
                                                                                        {{ __('Edit') }}</a>
                                                                                    <a href="#" class="dropdown-item"
                                                                                ...
                                                                                @elseif(isset($permissions))
                                                                                    @if (in_array('edit bug report', $permissions))
                                                                                        <a href="#" class="dropdown-item"
                                                                                            ...
                                                                                            data-size="lg"
                                                                                            data-title="{{ __('Edit Bug') }}"
                                                                                            data-url="{{ route($client_keyword . 'projects.bug.report.edit', [$currentWorkspace->slug, $bug->project_id, $bug->id]) }}">
                                                                                            {{ __('Edit') }}
                                                                                        </a>
                                                                                    @endif
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <a href="#"
                                                                    ...
                                                                    class="h6 task-title">{{ $bug->title }}</a>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col">
                                                                    ...
                                                                    <div class="avatar-group">
                                                                        <a href="#" class="avatar rounded-circle avatar-sm">
                                                                            <img alt="image" data-toggle="tooltip"
                                                                                data-original-title="{{ $bug->user->name }}"
                                                                                @if ($bug->user->avatar) src="{{ asset('/storage/avatars/' . $bug->user->avatar) }}" @else avatar="{{ $bug->user->name }}"@endif>
                                                                        </a>
                                                                    </div>
                                                                @endif
                                                            </div>
