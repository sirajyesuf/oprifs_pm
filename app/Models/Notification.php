...
class Notification extends Model
{
    ...
    public function toHtml(){
        ...
        if($this->type == 'task_assign'){
            ...
            if($project){
                $slug = Workspace::find($this->workspace_id)->slug;
                $link = route('projects.task.board',[$slug,$data->project_id]);
        ...
        elseif($this->type == 'project_assign'){
            ...
            $link = route('projects.show',[$slug,$data->id]);
        ...
        elseif($this->type == 'bug_assign'){
            ...
            $project = Project::find($data->project_id);
            if($project){
                $link = route('projects.bug.report',[$slug,$data->project_id]);
